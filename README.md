...
| Police State   | Карта полейского насилия. Инфографика по работе ОВД Москвы во время акций протеста | https://github.com/ivan-hilckov/police-arbitrariness-map |
...
| Стоп отписки | Сервис, который структурирует переписки с влястями и делает им публичным | https://github.com/HackSpb/stop_otpiski |
