...
5. 13 декабря **в 18:00** начнется хакатон — это значит, что вы с командой можете начать реализацию своей идеи
6. 15 декабря **в 18:00** хакатон завершается, мы ждем от вас документацию в readme.md со ссылкой на двухминутную презентацию вашего проекта (запись экрана)
