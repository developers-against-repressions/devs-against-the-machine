...
**Важное правило: проекты не должны нарушать законодательство РФ.**
...
| MadIdea        | Однокнопочный диктофон со стриминговым сохранением в облако и публикацией по принципу "мертвой руки" | https://github.com/Pitovsky/StreamingMic  |
| Police State   | Карта полицейского насилия. Инфографика по работе ОВД Москвы во время акций протеста | https://github.com/ivan-hilckov/police-arbitrariness-map |
| #VA            | Единый информационно-просветительный ресурс о политических репрессиях в России | https://github.com/valeryalexeev/repressions |
...
| Pokement       | Игра про полицию и покемонов | https://github.com/KlonD90/Pokement       |
| 42             | визуализированный таймлайн по политическим делам | https://github.com/agricolamz/2019.12.13-15_dev_against_the_machine |
| ROS            | Игра про журналиста      | https://github.com/rosdvp/newsmaker       |
...
| Peace Data     | Бот, зарегистрировавшись в котором, можно участвовать в заседаниях/ездить в овд/писать документы. Соединяет правозащитников и политзаков | https://gitlab.com/pavertomato/lapp       |
...
| Стоп отписки | Сервис, который структурирует переписки с властями и делает им публичным | https://github.com/HackSpb/stop_otpiski   |
| Assembly team  | Игра про нелёгкие будни депутатов Госдумы | https://github.com/CORRUPTOR2037/real-politikz-game |
| people_in_ovd_search_bot | Телеграм-бот, обеспечивающий координацию поиска людей, увезенных в неизвестное ОВД, путем обзвона ОВД в определенном регионе. | https://gitlab.com/ogarokpeter/people_in_ovd_search_bot |
...
| spirit         | Умная поддержка - веб приложение для объединения сил по поддержке политзеков | https://github.com/taigabrew/spirit       |
| Boogieman Team | Бот-помошник связывающий волонтеров и заключенных | https://github.com/EvilSocks/avtozak_help |
...
| after_hope     | Бот/сайт со всем необходимым для организации вечеров политзаключенных | https://github.com/KichiginaTatiana/after_hope |
